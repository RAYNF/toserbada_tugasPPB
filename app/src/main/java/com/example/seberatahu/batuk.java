...
public class batuk extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        listBatuk listBatuk = new listBatuk(this,nama_tanaman,gambar_tanaman,keterangan);
        listView.setAdapter(listBatuk);
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            String ket = keterangan[position].toString();
                ...
                Toast.makeText(batuk.this, ""+nm_tanaman.trim(), Toast.LENGTH_SHORT).show();
                Intent intent = new Intent(batuk.this,detailjeruk.class);
