...
public class modelMenu {
    String nama_menu,harga_menu,satuan_menu;
    int gambar_menu;
    ...
    public  String getHarga_menu(){return harga_menu;}

    public  void setHarga_menu(String harga_menu){this.harga_menu = harga_menu;}
    ...
    public int getGambar_menu(){return  gambar_menu;}

    public  void setGambar_menu(int gambar_menu){this.gambar_menu = gambar_menu;}
}
